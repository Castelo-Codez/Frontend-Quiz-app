    ...
    <section>
        ...
        >
            <div class="left" aria-label="section 1">
                ...
                >
                    Welcome to the
                    <strong class="block font-[500]">Frontend Quiz!</strong>
                </h1>
                <p class="text-[1.2rem] italic mt-5 text-clr-p">
                    Pick a subject to get started.
                </p>
            </div>
            <div class="right" aria-label="navigation section">
                <nav role="navigation">
                    <ul role="list" aria-label="navigation list">
                        ...
                        >
                            ...
                            >
                                <span
                                    aria-label="icon"
                                    class="flex justify-center items-center py-2 rounded-lg bg-orange-100 w-[45px] h-[45px]"
                                    ><svg
                        ...
                        >
                            ...
                            >
                                <span
                                    aria-label="icon"
                                    class="flex justify-center items-center py-2 rounded-lg bg-green-100 w-[45px] h-[45px]"
                                    ><svg
                                        xmlns="http://www.w3.org/2000/svg"
                                        width="40"
                                        height="40"
                        ...
                        >
                            ...
                            >
                                <span
                                    aria-label="icon"
                                    class="flex justify-center items-center py-2 rounded-lg bg-sky-50 w-[45px] h-[45px]"
                                    ><svg
                                        xmlns="http://www.w3.org/2000/svg"
                                        width="40"
                                        height="40"
                        ...
                        >
                            ...
                            >
                                <span
                                    aria-label="icon"
                                    class="flex justify-center items-center py-2 rounded-lg bg-purple-100 w-[45px] h-[45px]"
                                    ><svg
                                        xmlns="http://www.w3.org/2000/svg"
                                        width="40"
                                        height="40"
